...
public class Vendor implements Serializable {
    ...
    public void insertData() throws Exception {
        ...
        try {
            ...
            String testVenName = "Select * from vendor_table where vendor_name=?";
                ...
                while (rs.next()) {
                    ...
                    if (count == 0) {
                        ...
                        String insert = "insert into vendor_table (vendor_id,vendor_name,vendor_phone,vendor_email,vendor_contact,vendor_bank,vendor_acct_num,"
                                + "created_by,role_id,date_created,date_time_created,Role) "
                                + "values(?,?,?,?,?,?,?,?,?,?,?,?)";
                        ...
                        String vendor = "VEN" + String.valueOf(vendor_id);
                        String insert = "insert into vendor_table (vendor_id,vendor_name,vendor_phone,vendor_email,vendor_contact,vendor_bank,vendor_acct_num,"
                                + "created_by,role_id,date_created,date_time_created,Role,updatedBy) "
                                + "values(?,?,?,?,?,?,?,?,?,?,?,?,?)";
                        ...
                        setMessangerOfTruth("Ve Created!!");
                        vendorList = vendorTable();
                        msg = new FacesMessage(FacesMessage.SEVERITY_INFO, getMessangerOfTruth(), getMessangerOfTruth());
                        context.addMessage(null, msg);
                        refresh();
    ...
    public List<TableModel> vendorTable() throws Exception {
        ...
        try {
            ...
            con = dbConnections.mySqlDBconnection();
            String query = "SELECT * FROM vendor_table order by id desc";
            pstmt = con.prepareStatement(query);
            rs = pstmt.executeQuery();
            //
    ...
    public void onRowEdit(RowEditEvent event) throws Exception {
        ...
        try {
            ...
            String testname = "select vendor_Id,count(vendor_name) as total from pharm_db.vendor_table where vendor_name=?";
            ...
            while (rs.next()) {
                ...
                if (count <= 1 && venId.equals(((TableModel) event.getObject()).getVendorId())) {
    ...
    public void onRowEdits(RowEditEvent event) {
        FacesMessage msg = new FacesMessage("Vendor Edited" + ((TableModel) event.getObject()).getVendorId(), ((TableModel) event.getObject()).getVendorId());
